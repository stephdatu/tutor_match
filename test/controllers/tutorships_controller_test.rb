...
class TutorshipsControllerTest < ActionController::TestCase
  ...
  test "should create tutorship" do
    assert_difference('Tutorship.count') do
      post :create, tutorship: { student: @tutorship.student, subject: @tutorship.subject, tutor: @tutorship.tutor }
    end
  ...
  test "should update tutorship" do
    patch :update, id: @tutorship, tutorship: { student: @tutorship.student, subject: @tutorship.subject, tutor: @tutorship.tutor }
    assert_redirected_to tutorship_path(assigns(:tutorship))
  end
